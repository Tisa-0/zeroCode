export default {
  ...
  dataset: {
    ...
    add_group_field: '新建分组字段',
    please_select_groupable_field: '请先在元数据中选中一个维度字段（文本、时间或地理位置类型）',
    new_grouping: '新建分组',
    name_label: '名称',
    original_field: '原始字段',
    add_to: '添加到',
    search_value_placeholder: '输入搜索文字',
    add_remaining_to_other: '其余添加到"其他"',
    new_group: '新建分组',
    ungroup: '取消分组',
    reset: '重置',
    select_group_field: '选择分组字段',
    group_config: '分组配置',
    group_type: '分组类型',
    group_step: '步长',
    group_quantity: '数量',
